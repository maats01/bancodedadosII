...
namespace EFTransporteAereo.Controllers
{
    public class FabricantesController : Controller
    {
        ...
        public FabricantesController(TransporteAereoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Fabricante1")] Fabricante fabricante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Fabricante1")] Fabricante fabricante)
        {
            if (id != fabricante.Id)
            {
                return NotFound();
