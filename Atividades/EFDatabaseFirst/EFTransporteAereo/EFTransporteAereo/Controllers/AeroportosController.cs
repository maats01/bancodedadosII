...
namespace EFTransporteAereo.Controllers
{
    public class AeroportosController : Controller
    {
        ...
        public AeroportosController(TransporteAereoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeAeroporto,Cidade,Estado,Pais")] Aeroporto aeroporto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomeAeroporto,Cidade,Estado,Pais")] Aeroporto aeroporto)
        {
            if (id != aeroporto.Id)
            {
                return NotFound();
