...
namespace TorneioEF.Controllers
{
    public class ModalidadesController : Controller
    {
        ...
        public ModalidadesController(TorneioContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Modalidade1")] Modalidade modalidade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Modalidade1")] Modalidade modalidade)
        {
            if (id != modalidade.Id)
            {
                return NotFound();
