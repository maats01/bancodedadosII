...
namespace CategoriaItem.Controllers
{
    public class ItemController : Controller
    {
        ...
        {
            var myDbContext = _context.Itens.Include(i => i.Categoria);
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,CategoriaId")] Item item)
        {
            ...
            {
                _context.Add(item);
                var categoria = _context.Categorias.Where(categoria => categoria.Id == item.CategoriaId).Single();
                categoria.QtdItens++;
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (item != null)
            {
                var categoria = _context.Categorias.Where(categoria => categoria.Id == item.CategoriaId).First();
                categoria.QtdItens--;
